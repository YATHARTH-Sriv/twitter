...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', email: string, firstname: string, id: string, lastname: string, profileimageURL?: string | null } | null };
